Facial recognition extension for LensMemoriae. Automatically detects faces in
photographs and groups them by person using the `face_recognition` Python library.
